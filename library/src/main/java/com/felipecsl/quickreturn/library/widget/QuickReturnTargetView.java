...
public abstract class QuickReturnTargetView {
  ...
  /**
   * Returns the quick return target view alignment. Will be either 0 (POSITION_TOP) or 1
   * (POSITION_BOTTOM)
   */
  ...
  /**
   * Sets the quick return target view alignment to either 0 (POSITION_TOP) or 1 (POSITION_BOTTOM).
   *
