...
public abstract class QuickReturnAttacher {
  public static QuickReturnAttacher forView(ViewGroup viewGroup) {
    ...
    throw new UnsupportedOperationException(
        "Invalid viewGroup instance. It must be a subclass of AbsListView or ObservableScrollView");
  }

  public abstract QuickReturnTargetView addTargetView(View view, int position);

  public abstract QuickReturnTargetView addTargetView(View view, int position, int viewHeight);
}
